                    ...
                    if(mysqli_num_rows($orders)>0){
                        ...
                        if($orderItemResult){
                            if(mysqli_num_rows($orderItemResult)>0){
                                ?>
                                <h4 clas="my-3">Order Item Details</h4>
                                ...
                                <tbody>
                                    <?php foreach($orderItemResult as $item) :?>
                                        <tr>
                                         <td><?=$item['name']; ?></td>
                                         <td width="15%" class="fw-bold text-center"><?=number_format($item['orderItemPrice'],0); ?></td>
                                         <td width="15%" class="fw-bold text-center"><?= $item['orderItemQuantity']; ?></td>
                                         <td width="15%" class="fw-bold text-center"><?=number_format($item['orderItemPrice']*$item['orderItemQuantity'],0 ); ?></td>
                                        </tr>

                                        <?php endforeach;?>
                                        <tr>
                                            <td class="text-end fw-bold">Total Price:</td>
                                            <td colspan="3" class="text-end fw-bold">Rs:<?=number_format($item['total_amount'],0); ?></td>
                                        </tr>
